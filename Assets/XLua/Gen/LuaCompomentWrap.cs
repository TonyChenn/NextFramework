...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaCompomentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaCompoment);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaCompoment gen_ret = new LuaCompoment();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaCompoment constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                LuaCompoment gen_to_be_invoked = (LuaCompoment)translator.FastGetCSObj(L, 1);
