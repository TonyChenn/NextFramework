...
namespace NextFramework
{
    public class NextFrameworkInitWnd : EditorWindow
    {
        ...
        static void StartInit()
        {
            ...
            //UITexture
            PathHelper.CombinePath(PathConfig.RootPath, PathConfig.UITextureFolder).CreateFolderIfNotExist();
            //UIAtlas
        ...
        [MenuItem("Tools/Tools/取消MipMaps")]
        ...
        [MenuItem("Tools/打开路径/Persistent Path")]
        static void openPersistentPath()
        {
            EditorUtility.RevealInFinder(Application.persistentDataPath);
        }
        [MenuItem("Tools/打开路径/AssetBundle库")]
        static void openABDataBase()
        {
            EditorUtility.RevealInFinder($"{PathConfig.RootPath}/{PathConfig.AssetBundleFolder}");
        }
