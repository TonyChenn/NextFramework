...
namespace NextFramework.UI
{
    ...
    public class SImageEditor : GraphicEditor
    {
        ...
        /// <summary>
        /// Select Atlas Callback
        /// </summary>
        private void SelectAtlas(SpriteAtlas atlas)
        {
            serializedObject.Update();
            m_SpriteAtlas.objectReferenceValue = atlas;
            SUGUISetting.atlas = atlas;
            serializedObject.ApplyModifiedProperties();
            EditorUtility.SetDirty(serializedObject.targetObject);
            SelectSprite(atlas, null);
        }
    }
}
