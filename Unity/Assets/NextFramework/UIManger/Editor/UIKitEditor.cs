...
namespace NextFramework
{
    public class UIKitEditor
    {
        ...
        [MenuItem("Tools/UIKit/生成配置", true)]
        static bool CanGenConfig()
        {
            GameObject obj = Selection.activeObject as GameObject;
            if (obj == null) return false;
            return obj.GetComponent<UIWndBase>() != null;
        }

        [MenuItem("Assets/生成配置",false)]
        [MenuItem("Tools/UIKit/生成配置",false)]
        static void GenerateConfig()
        {
            ...
            //UIType
            string UITypePath = PathConfig.NextFrameworkPath + "/UIManger/UIType.cs";
        ...
        static List<Panel> getPanelList()
        {
            ...
            getPrefabsFromFolder(ref panelList, fileInfos);
            return panelList;
        }
