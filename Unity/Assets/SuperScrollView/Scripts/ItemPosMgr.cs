...
namespace NextFramework.UI
{
    public class ItemSizeGroup
    {
        ...
        public void Init()
        {
            ...
            mDirtyBeginIndex = mItemDefaultSize == 0 ? ItemPosMgr.mItemMaxCountPerGroup : 0;
        }
    ...
    public class ItemPosMgr
    {
        ...
        public void GetItemIndexAndPosAtGivenPos(float pos, ref int index, ref float itemPos)
        {
            ...
            int hitIndex = hitGroup.GetItemIndexByPos(pos - hitGroup.mGroupStartPos);
        ...
        {
            int count = mItemSizeGroupList.Count;
            if (count == 0 || mDirtyBeginIndex >= count) return;
